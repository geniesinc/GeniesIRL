...
namespace AndroidUltimatePlugin.Helpers.Editor
{
    public class FindMissingScriptsRecursively : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("See Console for [FindMissingScripts] log messages that point to affected Prefabs.");
            EditorGUILayout.EndHorizontal();
        }
        ...
        private static void FindInGO(GameObject g)
        {
            ...
            for (int i = 0; i < components.Length; i++)
            {
                ...
                if (components[i] == null)
                {
                    ...
                    Debug.Log("[FindMissingScripts]" + s + " has an empty script attached in position: " + i, g);
                }
            }
